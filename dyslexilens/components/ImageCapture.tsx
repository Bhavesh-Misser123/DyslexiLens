    ...
    return (
      <div className="space-y-5">
        <div className="rounded-2xl overflow-hidden border-2 border-focus/30 shadow-md">
          ...
          <img src={preview} alt="Captured preview" className="w-full object-contain max-h-80 bg-cream-100" />
        </div>
  ...
  return (
    <div className="space-y-5">
      ...
      <p className="text-center text-ink-300 text-xs">
        Camera requires browser permission. On desktop, allow access when prompted.
      </p>
    </div>
  );
}